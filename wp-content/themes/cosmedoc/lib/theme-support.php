...
if ( ! function_exists( 'cosmedoc_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function cosmedoc_theme_support() {
		// Add language support: @link {https://codex.wordpress.org/Multilingual_WordPress}
		load_theme_textdomain( 'cosmedoc', get_template_directory() . '/languages' );
	...
	add_action( 'after_setup_theme', 'cosmedoc_theme_support' );
endif;
