...
if ( ! class_exists( 'cosmedoc_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * cosmedoc_Protocol_Relative_Theme_Assets class
	 */
	class cosmedoc_Protocol_Relative_Theme_Assets {
		/**
	...
	$cosmedoc_protocol_relative_theme_assets = new cosmedoc_Protocol_Relative_Theme_Assets();
endif;
