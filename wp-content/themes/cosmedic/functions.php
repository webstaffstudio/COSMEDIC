 ...
 */
defined( 'THEME_TD' ) ? THEME_TD : define( 'THEME_TD', 'cosmedic' );
...
foreach ( $theme_includes as $file ) {
	if ( ! locate_template( $file ) ) {
		/* translators: %s error*/
		trigger_error( esc_html( sprintf( esc_html( __('Error locating %s for inclusion', 'cosmedic') ), $file ) ), E_USER_ERROR ); // phpcs:ignore
		continue;
	}
