...
if ( ! function_exists( 'cosmedic_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function cosmedic_theme_support() {
		// Add language support: @link {https://codex.wordpress.org/Multilingual_WordPress}
		load_theme_textdomain( 'cosmedic', get_template_directory() . '/languages' );
	...
	add_action( 'after_setup_theme', 'cosmedic_theme_support' );
endif;
