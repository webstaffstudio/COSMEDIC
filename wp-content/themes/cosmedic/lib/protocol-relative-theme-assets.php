...
if ( ! class_exists( 'Cosmedic_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Cosmedic_Protocol_Relative_Theme_Assets class
	 */
	class Cosmedic_Protocol_Relative_Theme_Assets {
		/**
	...
	$cosmedic_protocol_relative_theme_assets = new Cosmedic_Protocol_Relative_Theme_Assets();
endif;
