<?php
/**
 * Various functions required for cosmedic-bootstrap to work properly
 *
 * @package Cosmedic
 */
...
/**
 * cosmedic_navwalker class
 * Menu navigation walker
 * Class Name: cosmedic_navwalker
 * GitHub URI: https://github.com/twittem/wp-cosmedic-navwalker
 * Description: A custom WordPress nav walker class to implement the cosmedic 3 navigation style in a custom theme using the WordPress built in menu manager.
 */
...
/**
 * Pagination
 * Custom pagination with cosmedic .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-cosmedic/
 *
 * @param boolean $echo echo
 * @return string
 */
function cosmedic_pagination( $echo = true ) {
	global $wp_query;
	...
	class Betroot_Comments extends Walker_Comment {
		...
		<article id="comment-body-<?php comment_ID(); ?>" class="comment-body">
			...
			<section id="comment-content-<?php comment_ID(); ?>" class="comment">
					...
					<div class="notice">
						<p class="bottom"><?php _e( 'Your comment is awaiting moderation.', 'cosmedic' ); ?></p>
					</div>
